...
public class TestSegment {
    ...
    private static Path.Segment<T> makeSegment(Point start, Point end, Double cost) {
    ...
    public void testMakeSegment() {
        Path.Segment<T> segment = makeSegment(new Point(0.0, 0.0), new Point(0.0, 19.0), 19.0D);
    ...
    private static Path.Segment<T> seg1, seg2, seg3, seg4, seg5, seg6;
