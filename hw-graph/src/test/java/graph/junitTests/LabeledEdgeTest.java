...
public class LabeledEdgeTest {
    ...
    private final LabeledEdge<String, String> edge1 = new LabeledEdge<>("start1", "destination1", "edge1");
    private final LabeledEdge<String, String> edge2 = new LabeledEdge<>("start1", "destination1", "edge1");
    private final LabeledEdge<String, String> edge3 = new LabeledEdge<>("start1", "destination1", "edge12");
